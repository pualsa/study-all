...
public class ShoppingList {
  ...
  @Tool(
      name = "addItem",
      description =
          "Add an item to the shopping list or update its quantity. Specify item name and quantity.")
  public String addItem(
      @ToolParam(description = "The name of shopping item") String name,
      @ToolParam(description = "The quantity of the shopping items") int quantity) {
  ...
  @Tool(
      name = "getItems",
      description =
          "Get all items currently in the shopping list. Returns a list of items with their names and quantities.")
  ...
  @Tool(
      name = "removeItem",
      description =
          "Remove a specified quantity of an item from the shopping list. Specify item name and quantity to remove. If quantity is not specified or is greater than item quantity, the item is removed.")
  public String removeItem(
      @ToolParam(description = "The name of an item to remove") String name,
      @ToolParam(description = "The quantity of item to remove") int quantity) {
  ...
  private void printShoppingList() {
    ...
    shoppingList.forEach((key, item) -> System.out.println(item.name() + ": " + item.quantity()));
  }
}
